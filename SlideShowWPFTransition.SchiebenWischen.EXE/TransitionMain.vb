...
Imports SlideShowWPFTransition.SchiebenWischen
...
#Region "Variablendeklaration, Structures & Enums ect."
    ...
    Public Const SLIDESHOWTRANSITION_SuW_FULLPATH As String = SLIDESHOWTRANSITION_PATH & "Schieben & Wischen (WPF)\"
    Public Const nameTransition As String = "Schieben und Wischen (WPF)"
...
#End Region
    ...
    Sub RunTransition(oldImage As Image, picBoxModeOld As PictureBoxSizeMode, newImage As Image, picBoxModeNew As PictureBoxSizeMode, targetGraphics As Graphics, Optional clientSize As Size = Nothing, Optional durationMs As Integer = 0) Implements ISlideShowTransition.RunTransition
        Dim win As New SlideShowWPFTransition.SchiebenWischen.WpfTransitionWindow()
        ...
        win.Show()
        win.StartTransition(oldImg, newImg, 1500)
