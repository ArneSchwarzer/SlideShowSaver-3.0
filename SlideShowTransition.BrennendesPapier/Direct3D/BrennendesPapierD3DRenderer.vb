...
#Region "Initialisierung"
    ...
    Public Sub Initialisiere(breite As Integer, hoehe As Integer, oldImage As BitmapSource, newImage As BitmapSource,
                         brandMaske As BitmapSource, gradientBitmap As BitmapSource, brandkantenBreite As Single)
...
#Region "Rendering"
    ...
    Public Sub RenderFrame(progress As Single)
    ...
    Private Sub RenderSurface(surfacePointer As IntPtr, isNewSurface As Boolean)
        ...
        If oldImageView Is Nothing OrElse newImageView Is Nothing OrElse maskView Is Nothing Then
            Exit Sub
        End If
        ...
        Catch ex As Exception
            ...
            LogHandling.LogError("D3D: Fehler beim Rendern des RevealShaders: " & ex.ToString())
