// PartikelRenderShader.hlsl
//
// V0.8
//
// Erster produktiver Partikel-RenderShader.
//
...
VSOutput VSMain(uint vertexId : SV_VertexID)
{
    ...
    particleIndex = vertexId / VERTICES_PER_PARTICLE;

    cornerIndex = vertexId % VERTICES_PER_PARTICLE;
